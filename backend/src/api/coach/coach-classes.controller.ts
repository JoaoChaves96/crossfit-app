...
export class CoachClassesController {
   ...
   *
   * Authorization is enforced at the service level: only an active coach
   * in this gym whose userId matches the requesting user can see results.
   * No cross-gym or cross-coach access is possible.
   */
  @Get()
  @ApiOperation({
